...
void DirectX::DeviceResources::initializeDeviceResources()
{
...
void DirectX::DeviceResources::configureSwapChain()
{
...
void DirectX::DeviceResources::updateRenderTargetSize()
{
    ...
    m_outputSize.Width = DirectX::ConvertDipsToPixels(m_logicalSize.Width, m_effectiveDpi);
    m_outputSize.Height = DirectX::ConvertDipsToPixels(m_logicalSize.Height, m_effectiveDpi);
