...
DirectX::GameCamera::GameCamera(std::shared_ptr<DirectX::DeviceResources> spDeviceResource)
...
void DirectX::GameCamera::LockCamera()
{
    m_bIsCameraLocked = true;
}

void DirectX::GameCamera::UnlockCamera()
{
    m_bIsCameraLocked = false;
}

bool DirectX::GameCamera::IsCameraLocked()
{
    return m_bIsCameraLocked;
}

void DirectX::GameCamera::SyncCameraWithWindowSize()
{
...
void DirectX::GameCamera::RotateCamera(float radians)
{
