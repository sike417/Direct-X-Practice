...
namespace GraphicsScenes
{
    ...
    {
    public:
        RenderCubeScene(std::shared_ptr<DXResources::DeviceResources> spDeviceResource, std::shared_ptr<DXResources::GameCamera> spCamera);
    ...
    private:
        ...
        std::shared_ptr<DXResources::GameCamera> m_spCamera;
